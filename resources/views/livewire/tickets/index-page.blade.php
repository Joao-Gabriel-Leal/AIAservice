...
>
    ...
    >
        <x-slot:actions>
            ...
            @endif
            <a href="{{ route('tickets.export', $exportParams) }}" class="ui-action ui-action-secondary min-w-12 justify-center rounded-2xl px-4 py-3 text-sm" aria-label="Exportar Excel" title="Exportar Excel">
