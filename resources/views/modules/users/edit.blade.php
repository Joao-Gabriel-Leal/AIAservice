<x-layouts.portal title="Editar usuário">
    <form method="POST" action="{{ route('users.update', $userModel) }}" class="space-y-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        @csrf
        @method('PUT')
